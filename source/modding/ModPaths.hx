...
class ModPaths
{
	...
	{
		return getPath('songs/$key.txt', TEXT, mod);
	}

	inline static public function getModMainTxt(key:String, mod:String)
	{
	...
	{
		return getPath('songs/$key.json', TEXT, mod);
	}
	...
	inline static public function getModCharScript(key:String, mod:String)
	{
		return getPath('characters/$key.hx', TEXT, mod);
	}

    inline static public function getModWeek(key:String, mod:String)
	{
		return getPath('weeks/$key.json', TEXT, mod);
	}

    inline static public function getModEvent(key:String, mod:String)
	{
		return getPath('events/$key.hx', TEXT, mod);
	}

    inline static public function getModNotetype(key:String, mod:String)
	{
		return getPath('notetypes/$key.hx', TEXT, mod);
	}

    inline static public function getModScript(key:String, mod:String)
	{
		return getPath('scripts/$key.hx', TEXT, mod);
	}

    inline static public function getModScriptHelper(key:String, mod:String)
	{
		return getPath('scripts/$key.json', TEXT, mod);
	}
    ...
    inline static public function getModShader(key:String, mod:String)
	{
		return getPath('shaders/$key.frag', TEXT, mod);
	}
